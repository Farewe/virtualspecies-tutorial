...
$$ f(bio1) = a * bio1 + b $$
```{r resp4.1, echo = FALSE, cache = TRUE, fig.cap = "Fig. 2.3 Linear response function", fig.width = 3, fig.height = 2.5, results = "hide", fig.align = 'center'}
par(mar = c(3.1, 3.1, 0.1, 0.1))
formatFunctions(bio1 = c(fun = 'linearFun', a = 1, b = 0), x = worldclim[["bio1"]])
```

* Quadratic function: `formatFunctions(bio1 = c(fun = 'quadraticFun', a = -1, b = 2, c = 0))`
$$ f(bio1) = a \times bio1^2 + b \times bio1 + c$$
```{r resp4.2, echo = FALSE, cache = TRUE, fig.cap = "Fig. 2.4 Quadratic response function", fig.width = 3, fig.height = 2.5, results = "hide", fig.align = 'center'}
par(mar = c(3.1, 3.1, 0.1, 0.1))
formatFunctions(bio1 = c(fun = 'quadraticFun', a = -1, b = 2, c = 0), x = worldclim[["bio1"]])
```

* Logistic function: `formatFunctions(bio1 = c(fun = 'logisticFun', beta = 150, alpha = -5))`
$$ f(bio1) = \frac{1}{1 + e^{\frac{bio1 - \beta}{\alpha}}} $$
```{r resp4.3, echo = FALSE, cache = TRUE, fig.cap = "Fig. 2.5 Logistic response function", fig.width = 3, fig.height = 2.5, results = "hide", fig.align = 'center'}
par(mar = c(3.1, 3.1, 0.1, 0.1))
formatFunctions(bio1 = c(fun = 'logisticFun', beta = 150, alpha = -5), x = worldclim[["bio1"]])
```
...
```{r resp4.4, echo = FALSE, cache = TRUE, fig.cap = "Fig. 2.6 Normal function defined by extremes", fig.width = 3, fig.height = 2.5, results = "hide", fig.align = 'center'}
par(mar = c(3.1, 3.1, 0.1, 0.1))
formatFunctions(bio1 = c(fun = 'custnorm', mean = 250, diff = 50, prob = 0.99), x = worldclim[["bio1"]])
```
...
```{r resp4.5, fig.cap = "Fig. 2.7 Beta response function",  echo = FALSE, cache = TRUE, fig.width = 3, fig.height = 2.5, results = "hide", fig.align = 'center'}
par(mar = c(3.1, 3.1, 0.1, 0.1))
formatFunctions(bio1 = c(fun = 'betaFun', p1 = 0, p2 = 250, alpha = 0.9, gamma = 0.08), x = worldclim[["bio1"]])
```
...
# 8. Introducing a dispersal bias
...
```{r dist6, cache = TRUE, fig.cap = "Fig. 8.6 Occurrence sampled in the distribution of a species limited to South America", fig.width = 6, fig.height = 6}
my.first.species <- limitDistribution(my.first.species, 
                                      geographical.limit = "continent",
                                      area = "South America",
                                      plot = FALSE)
...
*Thank you for reading this tutoral, good luck on your work with virtualspecies!!*

And do not hesitate if you have a question, find a bug, or would like to add a feature in virtualspecies: _mail me at leroy.boris@gmail.com_
